...
//		while(app_uart_put('\n') != NRF_SUCCESS);
		 ...
		 switch(p_data[0]) {
				case '1':
				{
						...
						led_array[0].blue=0;
						led_array[1].red=0;
						led_array[1].green=255;
						led_array[1].blue=0;
						led_array[2].red=0;
						led_array[2].green=0;
						led_array[2].blue=255;
				}
				break;
				case '2':
				{
						...
						led_array[0].red=0;
						led_array[0].green=255;
						led_array[0].blue=0;
						led_array[1].red=0;
						led_array[1].green=255;
						led_array[1].blue=0;
						led_array[2].red=0;
						led_array[2].green=255;
						led_array[2].blue=0;
				...
				case '3':
				{
						led_array[0].red=60;
						led_array[0].green=0;
						led_array[0].blue=125;
						led_array[1].red=200;
						led_array[1].green=100;
						led_array[1].blue=90;
						led_array[2].red=30;
						led_array[2].green=170;
						led_array[2].blue=45;
